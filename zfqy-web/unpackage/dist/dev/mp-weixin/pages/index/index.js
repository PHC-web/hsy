...
/***/ 76:
/*!********************************************************************************************!*\
  !*** /Users/phc/Desktop/工作/个人项目/hsy/hsy/zfqy-web/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \********************************************************************************************/
...
var _index2 = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 77));
// @ts-ignore
...
/***/ 77:
/*!*************************************************************************!*\
  !*** /Users/phc/Desktop/工作/个人项目/hsy/hsy/zfqy-web/pages/index/index.vue ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ 78:
/*!********************************************************************************************************!*\
  !*** /Users/phc/Desktop/工作/个人项目/hsy/hsy/zfqy-web/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \********************************************************************************************************/
...
var render = function () {
  ...
  var m0 = _vm.toMoney(_vm.dashboard.withdrawAmount)
  var m1 = _vm.toMoney(_vm.dashboard.returnPaid)
  var m2 = _vm.toMoney(_vm.dashboard.returnDue)
...
/***/ 80:
/*!**************************************************************************************************!*\
  !*** /Users/phc/Desktop/工作/个人项目/hsy/hsy/zfqy-web/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  methods: {
    ...
    loadDashboard: function loadDashboard() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var db, dbCmd, _withdrawRes$result, _brandStatRes$result, _merchantRes$result, _memberRes$result, _brandRes$result, _machineRes$result, _activatedRes$result, _boundRes$result, _todayActivatedRes$re, todayStart, _yield$Promise$all, _yield$Promise$all2, brandRes, machineRes, activatedRes, boundRes, todayActivatedRes, withdrawRes, merchantRes, memberRes, withdrawRows, withdrawAmount, brandStatRes, brandRows, returnDue, returnPaid, userCount, memberCount, memberRate, returnRate;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 8;
                return Promise.all([db.collection('hsy-brand').where({
                  is_deleted: false
                }).count(), db.collection('hsy-machine').where({
                  is_deleted: false
                }).count(), db.collection('hsy-machine').where({
                  is_deleted: false,
                  is_activated: true
                ...
                }).count(), db.collection('hsy-withdraw-records').where({
                  is_deleted: false
                }).field('amount').limit(10000).get(), db.collection('hsy-merchant-users').count(), db.collection('hsy-merchant-users').where({
                  device_id: dbCmd.neq('')
                }).count()]);
              case 8:
                _yield$Promise$all = _context.sent;
                _yield$Promise$all2 = (0, _slicedToArray2.default)(_yield$Promise$all, 8);
                brandRes = _yield$Promise$all2[0];
                machineRes = _yield$Promise$all2[1];
                activatedRes = _yield$Promise$all2[2];
                boundRes = _yield$Promise$all2[3];
                todayActivatedRes = _yield$Promise$all2[4];
                withdrawRes = _yield$Promise$all2[5];
                merchantRes = _yield$Promise$all2[6];
                memberRes = _yield$Promise$all2[7];
                withdrawRows = ((_withdrawRes$result = withdrawRes.result) === null || _withdrawRes$result === void 0 ? void 0 : _withdrawRes$result.data) || [];
                withdrawAmount = withdrawRows.reduce(function (sum, item) {
                  return sum + Number(item.amount || 0);
                }, 0);
                _context.next = 22;
                return db.collection('hsy-brand').where({
                  is_deleted: false
                }).field('return_machine,return_payment').limit(10000).get();
              case 22:
                brandStatRes = _context.sent;
                brandRows = ((_brandStatRes$result = brandStatRes.result) === null || _brandStatRes$result === void 0 ? void 0 : _brandStatRes$result.data) || [];
                returnDue = brandRows.reduce(function (sum, item) {
                  return sum + Number(item.return_machine || 0);
                }, 0);
                returnPaid = brandRows.reduce(function (sum, item) {
                  return sum + Number(item.return_payment || 0);
                }, 0);
                userCount = ((_merchantRes$result = merchantRes.result) === null || _merchantRes$result === void 0 ? void 0 : _merchantRes$result.total) || 0;
                memberCount = ((_memberRes$result = memberRes.result) === null || _memberRes$result === void 0 ? void 0 : _memberRes$result.total) || 0;
                memberRate = userCount ? (memberCount / userCount * 100).toFixed(2) : '0.00';
                returnRate = returnDue ? (returnPaid / returnDue * 100).toFixed(2) : '0.00';
                _this.dashboard = {
                  brandCount: ((_brandRes$result = brandRes.result) === null || _brandRes$result === void 0 ? void 0 : _brandRes$result.total) || 0,
                  machineCount: ((_machineRes$result = machineRes.result) === null || _machineRes$result === void 0 ? void 0 : _machineRes$result.total) || 0,
                  activatedCount: ((_activatedRes$result = activatedRes.result) === null || _activatedRes$result === void 0 ? void 0 : _activatedRes$result.total) || 0,
                  boundCount: ((_boundRes$result = boundRes.result) === null || _boundRes$result === void 0 ? void 0 : _boundRes$result.total) || 0,
                  withdrawCount: withdrawRows.length,
                  withdrawAmount: withdrawAmount,
                  todayActivatedCount: ((_todayActivatedRes$re = todayActivatedRes.result) === null || _todayActivatedRes$re === void 0 ? void 0 : _todayActivatedRes$re.total) || 0,
                  userCount: userCount,
              ...
              case 33:
                ...
                uni.showModal({
                  content: _context.t0.message || '首页数据加载失败',
                  showCancel: false
                });
              case 36:
                _context.prev = 36;
...
/***/ 82:
/*!**********************************************************************************************************!*\
  !*** /Users/phc/Desktop/工作/个人项目/hsy/hsy/zfqy-web/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
